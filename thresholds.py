#!/usr/bin/env python
#
# thresholds.py - utility for reading the output from a run of setVbias
#                 and use that information to compute values for the
#                 online pedestals to use for optimal efficiency and
...
ttab_tagm = {3: [3,2,1,6,5,4,1009,2009,3009,4009,5009,9,8,7,12,11],
             ...
             10: [2099,3099,4099,5099,99,98,97,102,101,100]}

def usage():
   print "Usage: thresholds.py <setVbias_logfile>"
   sys.exit(1)
